...
namespace CSharpExercises
{
    public static class Exercises
    {
      //  private static object system;
        ...
        public static string SayHello(string incomingName)
        {
        ...
        public static string ReverseStringHard(string userInput)
        {
            char[] splitInput = userInput.ToCharArray();


            string reversIt = string.Empty;
            for (var i = splitInput.Length - 1; i >= 0; i--)
            {
                reversIt += splitInput[i];
            }
            //        Console.WriteLine(reversIt);
            return reversIt;
        }
        ...
        public static string ReverseStringEasy(string givenName)
        {
            char[] splitNames = givenName.ToCharArray();
            Array.Reverse(splitNames);
            return new string(splitNames);
        }
        ...
        public static string PrintTimesTable(int inputNo)
        {
            // var returnString = "";
            var products = 0;
            string mainString = "";
            for (var i = 1; i < 10; i++)
            {
                ...
                mainString += inputNo + " * " + i + " = " + products + "\r\n";
            }
            mainString += inputNo + " * " + 10 + " = " + (inputNo * 10);
            return mainString;
        ...
        public static double ConvertKelvinToFahrenheit(double Kalvin)
        {
            double tempFarn;
            tempFarn = (Kalvin - 273.15) * 1.80 + 32.0;
            return tempFarn = Math.Round(tempFarn, 2);
        }
        ...
        public static double GetAverageHard(int[] incoming)
        {
            double result = 0;
            double avg = 0;
        ...
        public static double GetAverageEasy(int[] incoming)
        {
        ...
        public static string DrawTriangle(int number, int width)
        {
            ...
            for (var i= width; i>=0; i--)
            {
                for (var j=i;j >=1; j--)
                {
                    shape += number.ToString();
                }

                if (i >= 2)
                {
                    shape += System.Environment.NewLine;
                }
            }
        ...
        public static Boolean IsVowel(char para)
        {
            // string[] vowel = { "a", "e", "i", "o", "u" };
            bool vowel = false;
            if("aeiouAEIOU".IndexOf(para) >= 0)
            {
                vowel = true;
            }
            return vowel; 
        ...
        public static Boolean IsConsonant(char alphabet)
        {
            bool consnt = true;
            if ("aeiouAEIOU".IndexOf(alphabet) >= 0)
            {
                consnt = false;
            }
                return consnt;
        ...
        // Beginning with an integer n > 1, repeat the following until n == 1. If n is even, halve it. If n is odd, triple it and add 1. Following these steps,
        //the function will always arrive at the number 1.
     ...
     //       Console.WriteLine(noSteps);
        ...
        public static string DuckGoose(int numberGiven)
        {
            ...
            for (int i = 1; i < numberGiven + 1; i++)
            {
                ...
                {
                   // string number = numberGiven.ToString();
